...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register as a ') }}{{ $type }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="streetNumber" class="col-md-4 col-form-label text-md-right">{{ __('Street No') }}</label>

                            <div class="col-md-6">
                                <input id="streetNumber" type="text" class="form-control @error('streetNumber') is-invalid @enderror" name="streetNumber" value="{{ old('streetNumber') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="streetName" type="text" class="form-control @error('streetName') is-invalid @enderror" name="streetName" value="{{ old('streetName') }}">
